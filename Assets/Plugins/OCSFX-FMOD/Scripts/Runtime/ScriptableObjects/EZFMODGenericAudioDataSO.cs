...
{
    [CreateAssetMenu(menuName = _CREATE_ASSET_MENU_BASE + "Generic", fileName = nameof(EZFMODGenericAudioDataSO))]
    public class EZFMODGenericAudioDataSO: EZFMODAudioDataSO
    {
