...
namespace GameOff2024.Cameras
{
    public class TempCameraController : MonoBehaviour
    {
        ...
        {
            if (UnityEngine.Input.GetKeyDown(_camera1Key))
            {
                SetActiveCamera(0);
            }
            else if (UnityEngine.Input.GetKeyDown(_camera2Key))
            {
                SetActiveCamera(1);
            }
            else if (UnityEngine.Input.GetKeyDown(_camera3Key))
            {
                SetActiveCamera(2);
            }
            else if (UnityEngine.Input.GetKeyDown(_camera4Key))
            {
                SetActiveCamera(3);
            }
        }
