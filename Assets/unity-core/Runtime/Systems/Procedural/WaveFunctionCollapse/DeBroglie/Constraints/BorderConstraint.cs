...
namespace DeBroglie.Constraints
{
    ...
    public class BorderConstraint : ITileConstraint
    {
        ...
        {
            var tiles = propagator.CreateTileSet(this.Tiles);
            ...
            for (var x = 0; x < width; x++)
            {
                ...
                for (var y = 0; y < height; y++)
                {
                    ...
                    for (var z = 0; z < depth; z++)
                    {
                        ...
                        var match = (this.Match(this.Sides, xmin, xmax, ymin, ymax, zmin, zmax) &&
                                     !this.Match(this.ExcludeSides, xmin, xmax, ymin, ymax, zmin, zmax)) != this.InvertArea;
