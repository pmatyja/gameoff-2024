...
namespace DeBroglie.Topo
{
    ...
    public class GraphTopology : ITopology
    {
        ...
        {
            this.indexCount = neighbours.GetLength(0);
            this.directionsCount = neighbours.GetLength(1);
        ...
        public int DirectionsCount => this.directionsCount;

        public int Width => this.indexCount;

        public int Height => 1;

        public int Depth => 1;

        public bool[] Mask => this.mask;

        public GraphTopology WithMask(bool[] mask)
        {
            return new GraphTopology(this.neighbours, mask);
        }
        ...
        {
            var neighbour = this.neighbours[index, (int)direction];
        ...
        {
            var neighbour = this.neighbours[x, (int)direction];
            dest = neighbour.Index;
            return neighbour.Index >= 0;
        }
